...
export class RecordTable extends MyTable {
    ...
    private tableType: "trade" | "dividend";
    private CLASSNAME_RECORD_TABLE_ROW: string;
    ...
    constructor(tableBodyDiv: HTMLElement, crudFunction: Function, tableType: "trade" | "dividend") {
        super(tableBodyDiv);
