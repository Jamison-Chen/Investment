        ...
        if (this.tableBodyDiv !== null) {
            for (let eachRecord of data) {
                ...
                for (let eachField in eachRecord) {
                    ...
                    if (eachField.toLowerCase() === this.CLASSNAME_ID)
